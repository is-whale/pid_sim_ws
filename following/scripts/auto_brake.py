...
class Obstacle():
    def __init__(self):
        self.lidar_detect_distance = 1.0   #避障距离为1m
    ...
    def update_status(self,angle,distance):
        cmd_pub = rospy.Publisher('/auto_brake/cmd_vel', Twist, queue_size=10)
        twist = Twist()
        ...
        # else:
        #     follow_sub = rospy.Subscriber('/auto_brake/cmd_vel',Twist,self.getfollowcmd,queue_size=10)
        #     try:
